    ...
    return (
        <div className={'hbup-tasklist-container flex gap-4'}>
            ...
            <div className="hbup-tasklist-info">
                <h3 className={`hbup-task m-0 font-sm font-500 ${checked ? 'hbup-task-completed':''}`}>Figma Basics</h3>
                <p className="hbup-date m-0 font-xs font-400">Friday, 10 June 2024</p>
            </div>
        </div>
    )
}