    ...
    return (
        <div className="hbup-mood-container">
            <div className="hbup-mood-section">
                <SectionDatePicker />
                <h3 className="m-0 font-sm font-500 text-grey-dark">Track your emotional journey with mindful awareness</h3>
            </div>
            <div className="hbup-mood-section mt-4 flex gap-2">
                <Card className="flex-1">
                    <h3 className="text-center m-0 font-md font-600">Your mood Today</h3>
                    <MoodProgress />
                ...
                <Card className="flex-2">
                    <h3 className="text-center m-0 font-md font-600">This week</h3>
            ...
            <div className="hbup-mood-section mt-4 gap-2">
                <Card>
                    <h3 className="m-0 font-sm font-500">
                        Log your Mood
                    </h3>
                    <p className="text-center font-sm font-400">Pick the emoji that suits your mood</p>
