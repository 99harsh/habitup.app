...
export default function Reflection() {
    return (
        <div className="hbup-reflection-container">
            ...
            <div className="hbup-reflection-section mt-4">
                <Card>
                    <h3 className="m-0 font-sm font-500 text-primary">Reflection Prompts</h3>
                    <div className="grid grid-cols-3 gap-2 mt-4">
                        <button className="hbup-reflection-prompt px-3 py-2">What made me feel happy today?</button>
                        <button className="hbup-reflection-prompt px-3 py-2">What made me feel happy today?</button>
                        <button className="hbup-reflection-prompt px-3 py-2">What made me feel happy today?</button>
                        <button className="hbup-reflection-prompt px-3 py-2">What made me feel happy today?</button>
                        <button className="hbup-reflection-prompt px-3 py-2">What made me feel happy today?</button>
